...
export default function Card({type, link, title , _id , date } : CardProps){
  ...
  function deleteHandler(){
    ...
    return(
      ...
      <div className='border-1 border-gray-300 w-90 h-65  rounded-xl relative flex justify-center items-center'>
  
       <div className={`md:text-xl text-lg font-semibold flex justify-between `} >
