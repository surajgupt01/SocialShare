...
export default  function Home(){
    ...
    return(
        <div className="p-5 w-full h-screen backdrop-blur-lg bg-neutral-900 ">
          ...
          <button onClick={navigator} className="rounded-4xl md:p-3  sm:p-3 p-2 md:text-md sm:text-md text-sm text-center cursor-pointer  bg-gray-800 text-white  font-semibold md:w-35 sm:w-35 w-28 duration-500 ease-in-out hover:text-black hover:bg-gray-400 hover:border-1 h-12 mt-2 hover:border-blue-400">LogIn/SignUp</button>
...
<div className="font-bold sm:text-6xl text-5xl md:text-7xl  flex  justify-center  text-blue-500 w-full  ">
   Social <span className="ml-2 md:ml-5 text-blue-600">Share</span></div>
   
   <p className="font-semibold text-md mt-8 text-center text-gray-100 sm:text-md text-sm md:text-lg">"Found something interesting?"
       <br></br>
     ...
     <div className="sm:mt-10 mt-4 sm:p-5 p-2 flex ">
       ...
       <button type="button" className="  font-semibold rounded-md md:p-3 sm:p-2 p-2 border-1 border-gray-300 hover:outline-1  text-center mr-5 cursor-pointer bg-white md:w-40 animate-pulse shadow-sm duration-500 ease-in-out sm:w-40 w-30">Explore</button>
       <button onClick={navigator} className="rounded-md md:p-3 sm:p-2 p-2 cursor-pointer border-1 border-gray-900  bg-gray-700 text-white font-semibold md:w-40 hover:text-black hover:bg-gray-500 hover:border-gray-700 shadow-lg duration-500 ease-in-out sm:w-40 w-30 ">Get Started</button>
   </div>
