...
<div className="font-bold sm:text-6xl text-5xl md:text-7xl  flex  justify-center  text-blue-500 w-full mt-80 ">
   ...
   <p className="font-semibold text-md mt-8 text-center text-gray-600 sm:text-md text-sm md:text-lg">"Found something interesting?"
     ...
     <div className="sm:mt-10 mt-4 sm:p-5 p-2 flex ">
       ...
       <button onClick={navigator} className="rounded-md md:p-3 sm:p-2 p-2 cursor-pointer border-1 border-gray-500  bg-gray-800 text-white font-semibold md:w-40 hover:text-black hover:bg-white hover:border-gray-50 shadow-lg duration-500 ease-in-out sm:w-40 w-30 ">Get Started</button>
   </div>
